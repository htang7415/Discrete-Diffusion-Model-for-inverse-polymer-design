...
class GraphInverseDesigner:
    """Inverse design via generate-then-filter approach for graph models."""
    ...
    def __init__(
        ...
        """Initialize graph inverse designer.

        Args:
            sampler: GraphSampler for generation.
            property_predictor: GraphPropertyPredictor model.
    ...
    def _predict_batch(
        ...
        """Predict properties for a batch of SMILES using graph model.
