...
class GraphPropertyTrainer:
    ...
    def __init__(
        ...
        Args:
            model: Graph property predictor model.
    ...
    def train(self) -> Dict:
        ...
        """
        print(f"Training graph property head for {self.property_name}")
    ...
    def _train_step(self, batch: Dict[str, torch.Tensor]) -> float:
        ...
        Args:
            batch: Batch with X, E, M, labels tensors.
    ...
    def _save_checkpoint(self, val_loss: float, epoch: int) -> bool:
        ...
        checkpoint = {
            ...
            'property_head_state_dict': self.model.property_head.state_dict()
        }
